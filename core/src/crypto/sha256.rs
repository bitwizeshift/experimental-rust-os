...
impl Digest {
  ...
  pub unsafe fn from_str_unchecked(s: &str) -> Self {
    ...
    for i in 0..32 {
      ...
      result.0[i] = Self::hex_digit_to_u8(c0) << 4 | Self::hex_digit_to_u8(c1);
    }
    result
  }
  ...
  /// Converts an 8-bit ascii hexadecimal value into its correspondign integer
  /// form.
  ///
  /// # Arguments
  ///
  /// * `ascii` - the 8-bit ascii value
  unsafe fn hex_digit_to_u8(ascii: u8) -> u8 {
...
/// A 64-byte Block of data that may be
#[derive(Clone)]
#[repr(align(32))]
